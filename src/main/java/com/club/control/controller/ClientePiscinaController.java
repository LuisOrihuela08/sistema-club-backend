...
public class ClientePiscinaController {
	...
	public ResponseEntity<byte[]> exportarExcel(
		...
		byte[] excel = clientePiscinaService.exportarExcelFiltradoClientePiscina(dni, metodoPago, fechaInicio, desde, hasta);
		
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.parseMediaType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
		headers.setContentDisposition(ContentDisposition.attachment().filename("servicio-piscina.xlsx").build());
